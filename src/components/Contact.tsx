        ...
        <section id="contact" className="section-padding bg-background relative overflow-hidden">
            ...
            <div className="container-custom">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-bold mb-6">Pronto para digitalizar o seu negócio?</h2>
                        <p className="text-lg text-muted-foreground mb-8">
                            Vamos conversar sobre o seu projeto. Nossa equipe está pronta para entender seus desafios e propor a melhor solução técnica.
                        </p>
